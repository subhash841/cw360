...
<html>
    <head>
        ...
        <title>Crowd Wisdom360 - Login</title>
                ...
                <div class="modal-content nopadding">
                    ...
                    <div class="row">
                        <div class="col s10 offset-s1 black-text text-left" style="font-size: 10px;">
                           ...
                           <p>CrowdWisdom360 is a Skill based prediction Game. To play the games, a player must be quite knowledgeable and carry out appropriate research before predicting an outcome. The key elements of success in the games are</p>
                         
                        <p>- Knowledge of current affairs or the relevant topics</p>
                         <p>- Ability to use the knowledge to evaluate the current situation and clicking YES to a prediction at the right time</p>
                        <p>- Keep track of the situation to change your mind about a prediction</p>
                        <p>- Multiple accounts are not allowed</p>
                        <p>- ID and bank account details can be and will be sought if required</p>
                        <p>- Minors are not allowed</p>
                         
                        <p>The predictions serve as a source of information to the general public on the most likely outcome an event.</p> 
                         
                        <p>While there are no fees required to play these games, we charge in-game coins to play each game. Unless you wish to play a large number of games, there is no need to purchase any coins. You can earn these coins by participating our GK games. </p>
