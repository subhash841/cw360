...
$(function () {
    ...
    load_predictions(voice_list_offset);
...
function load_predictions(offset) {
    $.ajax({
        url: base_url + "Predictions/lists",
        method: "POST",
...
function getblock(data, top = false) {
    ...
    var a = $("<a/>", {
        href: base_url + 'Predictions/details/' + data.id + '/' + slug,
        class: "d-block pb-3",
...
////                                <a href="' + base_url + 'YourVoice/blog_detail/' + result['data'][i].id + '/' + slug + '" class="d-block pb-3" style="">\
